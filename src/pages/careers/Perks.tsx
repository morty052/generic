...
<div className="max-w-[85rem] px-4 sm:px-6 lg:px-8  mx-auto">
  ...
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    {/* <!-- Card --> */}
    <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl   dark:shadow-slate-700/[.7]">
    ...
    <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl   dark:shadow-slate-700/[.7]">
      ...
      <div className="p-4 md:p-6">
        ...
        <p className="mt-3 text-gray-500">
        Join a team that values your contribution and own a piece of the fastest growing fintech company in 2023.
        </p>
      </div>
      {/* <div className="mt-auto flex border-t border-gray-200 divide-x divide-gray-200  ">
        ...
        <a className="w-full py-3 px-4 inline-flex justify-center items-center gap-2 rounded-br-xl font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm sm:p-4     " href="#">
          View API
        </a>
      </div> */}
    </div>
