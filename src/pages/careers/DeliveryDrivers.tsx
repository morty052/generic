import { axistruck } from "../../assets"

type Props = {}

function DeliveryDrivers({}: Props) {
  return (
   <>
   {/* <!-- Features --> */}
<div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 py-8  mx-auto">
  ...
  <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    <div>
      <img className="rounded-xl" src={axistruck} alt="Image Description"/>
    </div>
    {/* <!-- End Col --> */}
      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="space-y-2 md:space-y-4">
          ...
          <p className="text-gray-500">
           we are in urgent need of competent and experienced delivery drivers in certain areas around the country. we encourage you to apply below if you meet the aforementioned requirements.
          </p>
        </div>
        {/* <!-- End Title --> */}
        ...
        <ul role="list" className="space-y-2 sm:space-y-4">
          <li className="flex space-x-3">
            ...
            <span className="text-sm sm:text-base text-gray-500">
              <span className="font-bold">Arizona</span> 
            </span>
          </li>
