  ...
  <div className="grid md:grid-cols-2 gap-12">
    <div className="lg:w-3/4">
      ...
      <p className="mt-3 text-gray-800 ">
        We help businesses bring ideas to life in the digital world, by designing and implementing the technology they need to win.
      </p>
    ...
    <div className="space-y-6 lg:space-y-10">
      ...
      <div className="flex">
        ...
        <div className="ml-5 sm:ml-8">
          ...
          <p className="mt-1 text-gray-600 ">
           We value our customers and strive to provide them with the best possible experience. We're committed to understanding and meeting the needs of our customers, and delivering products and services that exceed their expectations.
          </p>
        </div>
      </div>
      {/* <!-- End Icon Block --> */}
      ...
      <div className="flex">
        {/* <!-- Icon --> */}
        <span className="flex-shrink-0 inline-flex justify-center items-center w-[46px] h-[46px] rounded-full border border-gray-200 bg-white text-gray-800 shadow-sm mx-auto   0">
          <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
