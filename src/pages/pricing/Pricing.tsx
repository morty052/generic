    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="p-4 relative z-10 bg-white border rounded-xl md:p-10  ">
          ...
          <div className="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
            ...
            {/* <div className="flex justify-end">
              <button type="button" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm      ">Start free trial</button>
            </div> */}
          </div>
        </div>
        {/* <!-- End Card --> */}
      ...
      <div>
        ...
        <div className="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border rounded-xl md:p-10   ">
          ...
          <span className="absolute top-0 right-0 rounded-tr-xl rounded-bl-xl text-xs font-medium bg-gray-800 text-white py-1.5 px-3 ">Most popular</span>

          <div className="mt-5">
            <span className="text-6xl font-bold text-gray-800 ">$36</span>
          ...
          <div className="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
            ...
            {/* <div className="flex justify-end">
              <button type="button" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm ">Start free trial</button>
            </div> */}
          </div>
        </div>
        {/* <!-- End Card --> */}
...
<div className="relative">
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
    <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      <h2 className="text-2xl font-bold md:text-3xl md:leading-tight ">Compare plans</h2>
    </div>

    {/* <!-- Header --> */}
    <div className="hidden lg:block sticky top-0 left-0 py-2 bg-white/60 backdrop-blur-md /60">
      {/* <!-- Grid --> */}
      ...
      <ul className="grid lg:grid-cols-6 lg:gap-6">
        ...
        <li className="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 ">
          <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
            ...
            <svg className="w-5 h-5 text-blue-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
    ...
    <div className="hidden lg:block mt-6">
      ...
      <div className="grid grid-cols-6 gap-6">
        ...
        {/* <div className="col-span-1">
          <a className="w-full py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-500 transition-all text-sm      " >
            Get started
          </a>
        </div> */}
        {/* <!-- End Col --> */}
        ...
        {/* <div className="col-span-1">
          <a className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-3 text-center bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-lg hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white transition " >
            Get started
          </a>
        </div> */}
        {/* <!-- End Col --> */}
    ...
    {/* <div className="mt-8 md:mt-12 flex justify-center items-center gap-x-3">
      ...
      <button type="button" className="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-lg border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-500 transition-all text-sm      ">
        Contact us
      </button>
    </div> */}
    {/* <!-- End Button Group --> */}
