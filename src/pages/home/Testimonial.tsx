  ...
  <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col bg-white rounded-xl ">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 ">
              " With Chrome Axis, we're able to easily track our performance in full detail. It's become an essential tool for us to grow and engage with our audience. "
            </p>
          </div>
      ...
      <div className="flex h-auto">
        <div className="flex flex-col bg-white rounded-xl ">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 ">
              " Started using Chrome Axis 2 years ago. I went through multiple updates and changes and I'm very glad to see the consistency and effort made by the team. "
            </p>
          </div>
      ...
      <div className="flex h-auto">
        <div className="flex flex-col bg-white rounded-xl ">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 ">
              " Refreshing and Thought provoking technology and it changes my view about how I setup tmy business. Great UX, modern clean interface, and constant feedback on how to improve business operations. "
            </p>
          </div>
    ...
    <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
      ...
      <div>
        ...
        <p className="mt-1 text-gray-400">Data query efficiency</p>
      </div>
      {/* <!-- End Stats --> */}
      ...
      <div>
        ...
        <p className="mt-1 text-gray-400">Active axis instances</p>
      </div>
      {/* <!-- End Stats --> */}
      ...
      <div>
        ...
        <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">$437M</p>
        <p className="mt-1 text-gray-400">Saved by axis this year alone</p>
      </div>
      {/* <!-- End Stats --> */}
    </div>
    {/* <!-- End Grid --> */}
